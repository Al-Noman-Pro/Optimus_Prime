...
from Optimus_Prime.modules import ALL_MODULES
from Optimus_Prime.modules.helper_funcs.chat_status import is_user_admin
from Optimus_Prime.modules.helper_funcs.misc import paginate_modules
    ...
    try:
        if mod_match:
            ...
            text = "*{}* has the following settings for the *{}* module:\n\n".format(
                escape_markdown(chat.title), CHAT_SETTINGS[module].__mod_name__) + CHAT_SETTINGS[module].__chat_settings__(chat_id, user.id)
