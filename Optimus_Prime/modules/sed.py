...
from Optimus_Prime.modules.disable import DisableAbleMessageHandler
from Optimus_Prime.modules.helper_funcs.regex_helper import infinite_loop_check
    ...
    if sed_result and update.effective_message.reply_to_message:
        ...
        try:
            ...
            if "i" in flags and "g" in flags:
                ...
                text = regex.sub(
                    repl, repl_with, to_fix, count=1, flags=regex.I, timeout=3).strip()
            elif "g" in flags:
