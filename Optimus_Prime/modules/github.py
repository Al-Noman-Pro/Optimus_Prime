...
import Optimus_Prime.modules.helper_funcs.git_api as api
import Optimus_Prime.modules.sql.github_sql as sql

from Optimus_Prime.modules.sql.clear_cmd_sql import get_clearcmd
from Optimus_Prime import dispatcher, OWNER_ID, EVENT_LOGS, SUDO_USERS, SUPPORT_USERS
...
from Optimus_Prime.modules.helper_funcs.misc import delete
...
def getRelease(update: Update, context: CallbackContext):
    ...
    deletion(update, context, msg.reply_text(text, parse_mode=ParseMode.MARKDOWN))
    return
...
def deletion(update: Update, context: CallbackContext, delmsg):
    ...
    if cleartime:
        context.dispatcher(delete, delmsg, cleartime.time)
