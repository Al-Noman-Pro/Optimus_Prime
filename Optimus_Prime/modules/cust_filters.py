...
from Optimus_Prime import dispatcher, LOGGER, SUDO_USERS
from Optimus_Prime.modules.disable import DisableAbleCommandHandler
from Optimus_Prime.modules.helper_funcs.handlers import MessageHandlerChecker
from Optimus_Prime.modules.helper_funcs.chat_status import user_admin
from Optimus_Prime.modules.helper_funcs.extraction import extract_text
from Optimus_Prime.modules.helper_funcs.filters import CustomFilters
from Optimus_Prime.modules.helper_funcs.misc import build_keyboard_parser
from Optimus_Prime.modules.helper_funcs.msg_types import get_filter_type
from Optimus_Prime.modules.helper_funcs.string_handling import (
    split_quotes,
    button_markdown_parser,
    escape_invalid_curly_brackets,
    markdown_to_html,
)
from Optimus_Prime.modules.sql import cust_filters_sql as sql

from Optimus_Prime.modules.connection import connected

from Optimus_Prime.modules.helper_funcs.alternate import send_message, typing_action
...
def filters(update, context):
    ...
    args = msg.text.split(
        None, 1)  # use python's maxsplit to separate Cmd, keyword, and reply_text
    ...
    if not msg.reply_to_message and len(extracted) >= 2:
        ...
        if msg.reply_to_message.text:
            ...
            text_to_parsing = ""
        offset = len(
            text_to_parsing)  # set correct offset relative to command + notename
        text, buttons = button_markdown_parser(
