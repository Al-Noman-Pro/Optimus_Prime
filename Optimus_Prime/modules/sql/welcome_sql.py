...
from Optimus_Prime.modules.helper_funcs.msg_types import Types
from Optimus_Prime.modules.sql import BASE, SESSION
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "Optimus_Prime ou ni...nvm wrong anime.",  # op
