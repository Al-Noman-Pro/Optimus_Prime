...
import Optimus_Prime.modules.sql.notes_sql as sql
from Optimus_Prime import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Optimus_Prime.__main__ import DATA_IMPORT
from Optimus_Prime.modules.helper_funcs.chat_status import user_admin
from Optimus_Prime.modules.helper_funcs.alternate import typing_action

# from Optimus_Prime.modules.rules import get_rules
import Optimus_Prime.modules.sql.rules_sql as rulessql

# from Optimus_Prime.modules.sql import warns_sql as warnssql
import Optimus_Prime.modules.sql.blacklist_sql as blacklistsql
from Optimus_Prime.modules.sql import disable_sql as disabledsql

# from Optimus_Prime.modules.sql import cust_filters_sql as filtersql
# import Optimus_Prime.modules.sql.welcome_sql as welcsql
import Optimus_Prime.modules.sql.locks_sql as locksql
from Optimus_Prime.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Optimus_Prime{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Optimus_Prime{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Optimus_Prime-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl),
        timeout=360,
        reply_to_message_id=msg.message_id,
        parse_mode=ParseMode.MARKDOWN)
    os.remove("Optimus_Prime{}.backup".format(chat_id))  # Cleaning file
