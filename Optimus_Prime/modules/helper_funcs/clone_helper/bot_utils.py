...
from Optimus_Prime import download_dict, download_dict_lock, STATUS_LIMIT, StartTime
from Optimus_Prime.modules.helper_funcs.clone_helper.button_build import ButtonMaker
...
def get_readable_message():
    with download_dict_lock:
        ...
        currentTime = get_readable_time(time() - StartTime)
