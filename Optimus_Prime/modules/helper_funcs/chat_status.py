...
from Optimus_Prime import DEL_CMDS, SUDO_USERS, DEV_USERS, SUPPORT_USERS, SUPPORT_CHAT, TIGER_USERS, WHITELIST_USERS, OWNER_ID, dispatcher
...
from Optimus_Prime.modules import connection
