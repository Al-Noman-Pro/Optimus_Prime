...
from Optimus_Prime.modules.helper_funcs.url_uploader.display_progress import humanbytes
from Optimus_Prime.modules.helper_funcs.url_uploader.display_progress import progress_for_pyrogram
from Optimus_Prime.modules.helper_funcs.url_uploader.help_uploadbot import DownLoadFile
...
async def echo(bot, update):
        ...
        if e_response and "nonnumeric port" not in e_response:
            ...
            await bot.send_message(
                chat_id=update.chat.id,
                text=NO_VOID_FORMAT_FOUND.format(str(error_message)),
                reply_to_message_id=update.message_id,
                parse_mode="html",
