...
from Optimus_Prime.modules.helper_funcs.url_uploader.display_progress import progress_for_pyrogram, humanbytes
from Optimus_Prime.modules.helper_funcs.url_uploader.help_Nekmo_ffmpeg import generate_screen_shots
    ...
    if t_response:
        ...
        if file_size > TG_MAX_FILE_SIZE:
            ...
            if images is not None:
                i = 0
                caption = "@FlameOSGroup"
                if is_w_f:
                    caption = "@AtrociousBotSupport"
                for image in images:
