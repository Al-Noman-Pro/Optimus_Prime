...
from Optimus_Prime import pbot
from Optimus_Prime.modules.helper_funcs.errors import capture_err
from Optimus_Prime.modules.helper_funcs.sections import section
...
@pbot.on_message(filters.command("pdf"))
@capture_err
async def img_to_pdf(_, message: Message):
    ...
    if reply.media_group_id:
        messages = await pbot.get_media_group(
            message.chat.id,
            reply.message_id,
        )
