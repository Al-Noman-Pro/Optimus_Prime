...
import Optimus_Prime.modules.sql.global_bans_sql as sql
from Optimus_Prime.modules.sql.users_sql import get_user_com_chats
...
from Optimus_Prime.modules.helper_funcs.misc import send_to_list
...
def check_and_ban(update, user_id, should_message=True):
    ...
    if user_id in TIGER_USERS or user_id in WHITELIST_USERS:
        sw_ban = None
    else:
        try:
