...
import Optimus_Prime.modules.sql.global_bans_sql as gban_sql
import Optimus_Prime.modules.sql.users_sql as user_sql
from Optimus_Prime import DEV_USERS, OWNER_ID, dispatcher
