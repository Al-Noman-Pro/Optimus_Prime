...
import Optimus_Prime.modules.sql.welcome_sql as sql
import Optimus_Prime
from Optimus_Prime import (DEV_USERS,LOGGER,OWNER_ID,SUDO_USERS,SUPPORT_USERS,TIGER_USERS,sw,dispatcher,JOIN_LOGGER)
from Optimus_Prime.modules.helper_funcs.chat_status import (is_user_ban_protected,user_admin)
from Optimus_Prime.modules.helper_funcs.misc import build_keyboard, delete, revert_buttons
from Optimus_Prime.modules.helper_funcs.msg_types import get_welcome_type
from Optimus_Prime.modules.helper_funcs.string_handling import (escape_invalid_curly_brackets,markdown_parser)
from Optimus_Prime.modules.log_channel import loggable
from Optimus_Prime.modules.sql.clear_cmd_sql import get_clearcmd
...
def new_member(update: Update, context: CallbackContext):
    ...
    for new_mem in new_members:
        ...
        if new_mem.id == bot.id and not Optimus_Prime.ALLOW_CHATS:
        ...
        if should_welc:
            ...
            # Welcome TIGER_USERS
                ...
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
                    f"#USER_JOINED\n"
                    f"Bot TIGER_USERS just joined the group")
                continue

            # Welcome yourself
            elif new_mem.id == bot.id:
                update.effective_message.reply_text(
                    "Thanks for adding @AtrociousBot.\nJoin @AtrociousBotSupport for support.",
                    reply_to_message_id=reply,
